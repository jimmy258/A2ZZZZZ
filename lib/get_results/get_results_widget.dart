...
class GetResultsWidget extends StatefulWidget {
  GetResultsWidget({Key key}) : super(key: key);

  @override
  _GetResultsWidgetState createState() => _GetResultsWidgetState();
}

class _GetResultsWidgetState extends State<GetResultsWidget> {
  ...
  Widget build(BuildContext context) {
    final ref = DB.reference().child(Database.loggedDoctorId);
    return Scaffold(
      key: scaffoldKey,
      appBar: AppBar(
